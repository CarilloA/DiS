                ...
                <table class="table table-responsive mt-4">
                    <thead>
                        <tr>
                            ...
                            <th colspan="2">Restock Action</th>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($storeStock <= $data->reorder_level)
                                    <button type="button" class="btn btn-light" data-toggle="modal" data-target="#storeRestockModal{{ $data->product_id }}" style="1em">
                                        <strong>Store</strong>
                                    </button>
                                @else
                            ...
                            <td>
                                @if ($data->product_quantity <= $data->reorder_level)
                                    <button type="button" class="btn btn-light" data-toggle="modal" data-target="#stockroomRestockModal{{ $data->product_id }}">

        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('update_product', ['id' => $productJoined->product_id]) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input id="purchase_price_per_unit" type="text" class="form-control @error('purchase_price_per_unit') is-invalid @enderror" name="purchase_price_per_unit" value="{{ old('purchase_price_per_unit', $productJoined->purchase_price_per_unit) }}" pattern="^\d{1,6}(\.\d{1,2})?$" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input id="sale_price_per_unit" type="text" class="form-control @error('sale_price_per_unit') is-invalid @enderror" name="sale_price_per_unit" value="{{ old('sale_price_per_unit', $productJoined->sale_price_per_unit) }}" pattern="^\d{1,6}(\.\d{1,2})?$" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="custom-select">
                                    <select name="unit_of_measure" id="unit_of_measure" class="form-control  @error('unit_of_measure') is-invalid @enderror" required>
                                        <option value="pcs" @if(old('unit_of_measure', $productJoined->unit_of_measure) == 'pcs') selected @endif>piece</option>
                                        <option value="pair" @if(old('unit_of_measure', $productJoined->unit_of_measure) == 'pair') selected @endif>pair</option>
                                        <option value="set" @if(old('unit_of_measure', $productJoined->unit_of_measure) == 'set') selected @endif>set</option>
                                        <option value="box" @if(old('unit_of_measure', $productJoined->unit_of_measure) == 'box') selected @endif>box</option>
                                        <option value="pack" @if(old('unit_of_measure', $productJoined->unit_of_measure) == 'pack') selected @endif>pack</option>
                                        <option value="kit" @if(old('unit_of_measure', $productJoined->unit_of_measure) == 'kit') selected @endif>kit</option>
                                        <option value="liter" @if(old('unit_of_measure', $productJoined->unit_of_measure) == 'liter') selected @endif>liter</option>
                                        <option value="gallon" @if(old('unit_of_measure', $productJoined->unit_of_measure) == 'gallon') selected @endif>gallon</option>
                                        <option value="roll" @if(old('unit_of_measure', $productJoined->unit_of_measure) == 'roll') selected @endif>roll</option>
                                        <option value="meter" @if(old('unit_of_measure', $productJoined->unit_of_measure) == 'meter') selected @endif>meter</option>
                                    </select>
                                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input id="in_stock" type="text" class="form-control @error('in_stock') is-invalid @enderror" name="in_stock" value="{{ old('in_stock', $productJoined->in_stock) }}" pattern="^\d{1,6}$" required>
                                @error('in_stock')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                         ...
                         <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input id="product_quantity" type="number" class="form-control @error('product_quantity') is-invalid @enderror" name="product_quantity" value="{{ old('product_quantity', $productJoined->product_quantity) }}" }}" min="1" required>
                            ...
                            <div class="col-md-3">
                                <label class="input-group-text" for="supplier_dropdown">
                                    <i class="fa-solid fa-industry" style="margin-right: 5px;"></i> Select Supplier &nbsp;<i>*Required</i>
                                </label>
                                <div class="custom-select">
                                    <select id="supplier_dropdown" class="form-select" name="supplier_dropdown" required>
                                        ...
                                        @foreach($suppliers as $supplier)
                                            <option value="{{ $supplier->supplier_id }}" 
                                                @if(old('supplier_dropdown', $productJoined->supplier_id) == $supplier->supplier_id) selected @endif>

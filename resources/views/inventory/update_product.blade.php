...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center">{{ __('Update Product') }}</div>
                <div class="card-body">
                    <!-- Alert Messages -->
                    ...
                    <form method="POST" action="{{ url('update_product/' . $product->product_id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="unit_price" type="text" class="form-control @error('unit_price') is-invalid @enderror" name="unit_price" value="{{ $product->unit_price ?? '' }}" required>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input id="UoM" type="text" class="form-control @error('UoM') is-invalid @enderror" name="UoM" value="{{ $product->UoM ?? '' }}" required>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input id="quantity_in_stock" type="text" class="form-control @error('quantity_in_stock') is-invalid @enderror" name="quantity_in_stock" value="{{ $product->quantity_in_stock ?? '' }}" required>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input id="reorder_level" type="text" class="form-control @error('reorder_level') is-invalid @enderror" name="reorder_level" value="{{ $product->reorder_level ?? '' }}" required>
                                @error('reorder_level')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
